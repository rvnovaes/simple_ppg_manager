...
from apps.academic.router import access_router as academic_access_router
...
from apps.scholarships.router import router as scholarships_router
...
api.add_router("/access/", academic_access_router)
